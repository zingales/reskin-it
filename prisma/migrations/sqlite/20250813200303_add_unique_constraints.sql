...
*/
-- CreateIndex
CREATE UNIQUE INDEX "CardSet_title_userId_key" ON "CardSet"("title", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "TokenEngineCardDefinition_token_tier_points_key" ON "TokenEngineCardDefinition"("token", "tier", "points");
